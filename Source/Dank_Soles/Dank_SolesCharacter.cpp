...
void ADank_SolesCharacter::NotifyControllerChanged()
{
...
void ADank_SolesCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ADank_SolesCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
